...
- `docs/main/requirements.md`: muc `6.11 Admin Management` yeu cau admin quan ly danh sach user, tim kiem/loc user theo trang thai va goi dang ky.
- `docs/archive/plans/backend-code-plan.md`: Phase 9, Task 9.1 du kien migrate `UserController` admin/user list APIs.
...
Theo `docs/archive/plans/backend-code-plan.md`, Task 9.1 du kien endpoint:
