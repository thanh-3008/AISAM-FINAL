...
- `docs/main/requirements.md`: muc `8.1 Security` yeu cau phan quyen theo role; muc `6.11 Admin Management` yeu cau admin tools rieng cho quan tri vien.
- `docs/archive/plans/backend-code-plan.md`: Phase 9 yeu cau admin APIs co authorization role; non-admin goi endpoint admin-only phai nhan `401/403`.
