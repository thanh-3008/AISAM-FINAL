...
- `docs/main/requirements.md`: he thong dinh huong ho tro Facebook, Instagram va TikTok; Instagram Business Account ket noi OAuth trong pham vi duoc ho tro; mot so tinh nang co the bi gioi han boi app review/permission.
- `docs/archive/plans/backend-code-plan.md`: MVP backend chay truoc, chua om Instagram/TikTok day du; Phase 6 hien chi uu tien Facebook provider/publishing.
