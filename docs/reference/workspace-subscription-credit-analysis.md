...
- [x] `README.md`
- [x] `docs/main/requirements.md`
- [x] `docs/archive/plans/backend-code-plan.md`
- [x] `docs/main/setup-guide.md`
- [x] `docs/main/user-story-list.md`
- [x] `docs/archive/plans/frontend-code-plan.md`
- [x] `docs/reference/specification-answers.md`
- [x] `docs/main/development-guardrails.md`
- [x] `docs/reference/backend-progress-vs-srs.md`
- [x] `docs/reference/user-stories/us-44.md`
- [x] `docs/reference/user-stories/us-45.md`
- [x] `docs/reference/user-stories/us-47.md`
- [x] `docs/reference/user-stories/US-53-admin-profile-subscription-payment-story-detail.md`
- [x] `docs/reference/user-stories/US-56-ownership-boundary-testing-story-detail.md`
- [x] `docs/reference/user-stories/US-59-team-permissions-story-detail.md`
- [x] `AISAM-FE/src/features/payment/README.md`
- [x] `docs/archive/plans/backend-code-plan.md`: da chot thu tu Phase 9 Workspace -> Phase 10 Admin theo Workspace -> Phase 11 Facebook Ads -> Phase 12 Release.
- [x] `docs/reference/user-stories/US-60-facebook-ads-mvp-story-detail.md`
...
- `docs/reference/user-stories/us-44.md`
- `docs/reference/user-stories/us-45.md`
- `docs/reference/user-stories/us-47.md`
- `docs/reference/user-stories/US-53-admin-profile-subscription-payment-story-detail.md`
- `docs/reference/user-stories/US-56-ownership-boundary-testing-story-detail.md`
- `docs/reference/user-stories/US-59-team-permissions-story-detail.md`
- `docs/reference/user-stories/US-66-dynamic-subscription-plan-management-story-detail.md`
