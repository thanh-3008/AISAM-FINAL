...
`docs/reference/workspace-subscription-credit-analysis.md` thay the cac de xuat cu lien quan den Profile subscription, Team Leader governance va AI quota.

Lifecycle/expiry policy moi nhat duoc chot tai `docs/main/workspace-subscription-expiry-policy.md`:
