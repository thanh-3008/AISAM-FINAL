...
Huong di da chot: bam theo `docs/archive/plans/backend-code-plan.md` lam khung phase chinh.
...
- `docs/main/development-guardrails.md`: quy tac lam tung buoc nho, source cu la baseline, khong refactor khong can thiet, moi phase phai build/test/API test.
- `docs/archive/plans/backend-code-plan.md`: khung phase 0-10 cho backend .NET 8.
...
- `README.md` va `docs/reference/backend-progress-vs-srs.md` mo ta source cu/vision day du hon active codebase hien tai.
...
Map voi `docs/archive/plans/backend-code-plan.md`: hoan tat/kiem tra lai Phase 0-4.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 5.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 6.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 7.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 8.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 9.
...
Map voi `docs/archive/plans/backend-code-plan.md`: Phase 10.
