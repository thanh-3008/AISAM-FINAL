...
Policy lifecycle/credit moi nhat: `docs/main/workspace-subscription-expiry-policy.md`.
...
- 
docs/main/requirements.md - Requirement tổng thể
- docs/archive/plans/backend-code-plan.md - Backend architecture + phases
