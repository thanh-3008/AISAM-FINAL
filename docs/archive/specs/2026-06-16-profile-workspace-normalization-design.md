...
> Product policy update 2026-06-24: workspace creation, paid-only Business behavior, expiry, and credit retention are defined by `docs/main/workspace-subscription-expiry-policy.md`. If this normalization spec conflicts with that policy, the product policy wins.
