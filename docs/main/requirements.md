...
Nguon quyet dinh: `docs/reference/workspace-subscription-credit-analysis.md`. Day la requirement muc tieu da phe duyet, **chua phai trang thai code hien tai**.

Chinh sach lifecycle moi nhat: `docs/main/workspace-subscription-expiry-policy.md` (approved 2026-06-24).
