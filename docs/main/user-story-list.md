...
Nguon: `docs/reference/workspace-subscription-credit-analysis.md`. Cac story duoi day **chua co trong code**:
...
US-80 policy source: `docs/main/workspace-subscription-expiry-policy.md`. Trang thai: approved policy, implementation/test audit required.

US-44 den US-50 ve payment/quota Profile la current baseline va se duoc migration sang Workspace, khong xoa lich su.

Danh sach duoi day bam sat active backend codebase hien tai, `docs/archive/plans/backend-code-plan.md`, `AISAM-BE/docs/superpowers/CODEBASE_UPDATE.md` va scope MVP thuc te. Cac user story duoc tach thanh 3 nhan de viet detail va bam roadmap cho khop:
