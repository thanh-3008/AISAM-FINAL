...
namespace DbTest
{
    class Program
    {
        ...
        {
            string connectionString = "Host=aws-0-ap-northeast-1.pooler.supabase.com;Database=postgres;Username=postgres.aoqgwztuazwpqreeloyo;Password=OuKNzld4JGhMyn3m;SSL Mode=Require;Trust Server Certificate=true";
