...
public sealed class AutomationService : IAutomationService
{
    ...
    public AutomationService(IAutomationRepository automationRepository, IBrandRepository brandRepository, IProductRepository productRepository, IAutomationCreditService automationCredits, ContentAuthorizationService? authorization = null, ExecutionAuthorizationService? executionAuthorization = null)
    {
