...
- `requirement.md`: admin la doi tuong van hanh he thong, co nhu cau quan ly user/profile/payment/subscription va ho tro tinh huong van hanh.
- `BACKEND_CODE_PLAN.md`: Phase 9, Task 9.2 du kien migrate `AdminToolsController` o muc an toan, gom endpoint `seed-demo-user`, seed batch users neu can, va update payment/subscription/profile status neu can.
...
Theo `BACKEND_CODE_PLAN.md`, Task 9.2 du kien endpoint:
