...
- `requirement.md`: muc `4.2 Team Leader / Approver`, `5.2 Team Leader / Approver Use Cases`, `6.7 Content Review and Approval`, va business rule "Chi content da duoc approve moi duoc len lich hoac dang bai".
- `BACKEND_CODE_PLAN.md`: Approval workflow khong nam trong active MVP hien tai, cac task backend tap trung Auth/Profile/Brand/Product/Content/AI/Social/Scheduling truoc.
