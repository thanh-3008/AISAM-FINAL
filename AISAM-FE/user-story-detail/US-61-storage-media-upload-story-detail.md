...
- `requirement.md`: he thong co external storage service de luu media va tai nguyen upload; media generation/publishing co the xu ly bat dong bo.
- `BACKEND_CODE_PLAN.md`: storage/Supabase khong nam trong MVP backend dau, chi cau hinh optional/future.
