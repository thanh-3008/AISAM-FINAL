...
- `requirement.md`: muc `6.11 Admin Management` yeu cau admin xem chi tiet user, profile, subscription va payment; tim kiem/loc user theo trang thai va goi dang ky; kich hoat/vo hieu hoa tai khoan.
- `BACKEND_CODE_PLAN.md`: Phase 8 du kien migrate Payment/Subscription/Quota; Phase 9 du kien migrate Admin backend MVP va `AdminToolsController` an toan.
