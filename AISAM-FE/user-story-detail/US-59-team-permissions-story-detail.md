...
- `requirement.md`: co vai tro Team Leader / Approver, approval workflow, team governance sau MVP.
- `BACKEND_CODE_PLAN.md`: Team/approval workflow duoc de sau vi phuc tap; Profile/Brand hien tai chua ho tro shared profile qua team.
