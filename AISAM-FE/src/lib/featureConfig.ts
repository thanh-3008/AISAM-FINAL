...
export const PERMISSION_MATRIX: Record<Permission, WorkspaceRole[]> = {
  viewDashboard: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator, WorkspaceRole.Viewer],
  viewAnalytics: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator, WorkspaceRole.Viewer],
  manageBrand: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  manageProduct: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  manageContent: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  manageCampaign: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  generateContent: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator],
  generateImage: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator],
  generateVideo: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator],
  createDraft: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager, WorkspaceRole.Member, WorkspaceRole.ContentCreator],
  reviewContent: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  publishPost: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  manageSchedules: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  viewTeamUsage: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  inviteMember: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  removeMember: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
  assignQuota: [WorkspaceRole.Owner, WorkspaceRole.WorkspaceManager, WorkspaceRole.Manager],
