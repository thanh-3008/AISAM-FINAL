...
import { type CreateTeamData, type TeamMember, fetchMembers } from "@/services/teamService";
...
export default function CreateTeamModal({ open, onClose, onCreate, isLoading }: CreateTeamModalProps) {
          ...
          <div className="p-6 border-b border-outline-variant/20 flex items-center justify-between sticky top-0 bg-surface-container-lowest z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-label-xs text-outline">Set up a new team and assign members</p>
              </div>
            </div>
