      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isLoading}
            className="flex items-center gap-1.5 px-4 py-2 bg-danger-red/10 hover:bg-danger-red/20 text-danger-red rounded-xl text-label-xs font-semibold transition-all disabled:opacity-50"
          >
            {isLoading ? (
          ...
          <button
            ...
            className="px-4 py-2 border border-outline-variant/30 hover:bg-surface-container rounded-xl text-label-xs font-semibold text-outline hover:text-on-surface transition-all"
          >
            Clear
          </button>
        </div>
