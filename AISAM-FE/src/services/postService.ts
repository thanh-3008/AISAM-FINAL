...
export type PostPlatform = "facebook" | "instagram" | "tiktok";
...
const MOCK_POSTS: PostItem[] = [
  ...
  { id: "p2", contentId: "c2", integrationId: "fb-1", externalPostId: "fb_post_2001", publishedAt: d(5, 30, 14, 0), status: "Published", contentTitle: "LED Strip Installation Guide", brandName: "Lumina Tech", platform: "facebook", type: "TEXT", caption: "A step-by-step guide to installing LED strips in any space. #DIY #Lighting...", likes: 560, comments: 32, shares: 45, createdAt: d(5, 20), updatedAt: d(5, 30, 14, 30) },
  ...
  { id: "p14", contentId: "c11", integrationId: "fb-1", externalPostId: "fb_post_2003", publishedAt: d(4, 28, 11, 0), status: "Published", contentTitle: "Pulse Finance Year in Review", brandName: "Pulse Finance", platform: "facebook", type: "TEXT", caption: "Our 2025 year in review — growth, challenges, and what's next. #Finance #YearInReview", likes: 4300, comments: 289, shares: 520, createdAt: d(4, 20), updatedAt: d(4, 28, 11, 45) },
  ...
  { id: "p9", contentId: "c13", integrationId: "ig-1", externalPostId: "ig_post_2002", publishedAt: d(6, 10, 9, 0), status: "Scheduled", contentTitle: "Morning Yoga Routine Tutorial", brandName: "Summit Outdoor", platform: "instagram", type: "VIDEO", caption: "Start your day right with this morning yoga routine. #Yoga #Wellness...", createdAt: d(6, 1), updatedAt: d(6, 1) },
  ...
  { id: "p19", contentId: "c8", integrationId: "fb-1", externalPostId: null, publishedAt: d(6, 20, 11, 0), status: "Scheduled", contentTitle: "All-Terrain Tire Tech Deep Dive", brandName: "Heritage Motors", platform: "facebook", type: "TEXT", caption: "The engineering behind our all-terrain tire technology. #Automotive #Tech", createdAt: d(6, 12), updatedAt: d(6, 12) },
  ...
  { id: "p6", contentId: "c10", integrationId: "ig-1", externalPostId: null, publishedAt: d(6, 4, 16, 20), status: "Failed", contentTitle: "Matcha Green Tea Powder Review", brandName: "GreenLeaf Organics", platform: "instagram", type: "IMAGE", caption: "Our honest review of matcha green tea powder. #Health #Wellness...", errorMessage: "API Timeout", createdAt: d(5, 30), updatedAt: d(6, 4, 16, 20) },
  ...
  { id: "p24", contentId: "c7", integrationId: "ig-1", externalPostId: null, publishedAt: d(5, 18, 10, 0), status: "Failed", contentTitle: "Heritage Motors Instagram Article", brandName: "Heritage Motors", platform: "instagram", type: "TEXT", caption: "The future of electric heritage vehicles. #EV #Automotive", errorMessage: "Content policy violation", createdAt: d(5, 12), updatedAt: d(5, 18, 10, 0) },
];
