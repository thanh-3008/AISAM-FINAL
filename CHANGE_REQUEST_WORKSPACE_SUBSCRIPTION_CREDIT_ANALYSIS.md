...
**25 quyết định, WorkspaceTypeEnum, Credits, Post Quota, Member Limit, Feature Matrix và Permission Matrix đã được lưu. Implementation đang ở Phase 9; Task 9.7 Invitation, Role Management và Member Limit đã hoàn thành và pass 186/186 tests. Personal Workspace có limit 1, Business Workspace mặc định limit 10 và hệ thống hỗ trợ limit 50 cho Business Pro; invite/accept đều enforce limit. Chỉ Owner được invite, đổi role và remove non-owner; Limited/Archived Workspace chỉ được xem team. Task tiếp theo là 9.8 Atomic Ownership Transfer. Task 9.9 sẽ tự động gán limit 10/50 theo Business Subscription plan.**
