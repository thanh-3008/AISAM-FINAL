...
**Cap nhat 2026-06-12: Phase 9 da hoan thanh Task 9.1-9.15. Workspace foundation, invitation/member role, ownership transfer, Workspace subscription/payment, Credit Wallet, credit pack, member quota, entitlement/permission, Post Quota, AI text generate/refine Credit charging va Limited/Archived/Admin Soft Delete lifecycle da co code va automated tests. AI chat khong tru Credits; provider failure khong tru Credits; Generate Text/Basic Analytics van duoc phep khi khong co active subscription neu Workspace con Credits. Task tiep theo la 9.16 chuyen ownership tung domain sang Workspace. Backfill du lieu cu van thuoc Task 9.17.**
