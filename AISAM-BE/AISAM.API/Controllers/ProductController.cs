    ...
    public class ProductController : ControllerBase
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var result = await _productService.GetPagedAsync(workspaceId, new PaginationRequest
                {
                    Page = page,
                    PageSize = pageSize,
                ...
                }, brandId, includeDeleted, cancellationToken);
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, GenericResponse<PagedResult<ProductResponseDto>>.CreateError("System error"));
            }
        }
        ...
        public async Task<ActionResult<GenericResponse<ProductResponseDto>>> GetById(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            {
                var workspaceId = WorkspaceContextHelper.GetActiveWorkspaceIdOrThrow(HttpContext);
                var result = await _productService.GetByIdAsync(id, workspaceId, cancellationToken);
                return StatusCode(result.StatusCode, result);
            }
            catch (UnauthorizedAccessException)
            {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, GenericResponse<ProductResponseDto>.CreateError("System error"));
            }
        }
        ...
        public async Task<ActionResult<GenericResponse<ProductResponseDto>>> Create([FromForm] ProductCreateRequest request, CancellationToken cancellationToken = default)
        {
            ...
            {
                var workspaceId = WorkspaceContextHelper.GetActiveWorkspaceIdOrThrow(HttpContext);
                var result = await _productService.CreateAsync(workspaceId, request, cancellationToken);
                if (result.Success)
                {
        ...
        public async Task<ActionResult<GenericResponse<ProductResponseDto>>> Update(Guid id, [FromForm] ProductUpdateRequestDto request, CancellationToken cancellationToken = default)
        {
            ...
            {
                var workspaceId = WorkspaceContextHelper.GetActiveWorkspaceIdOrThrow(HttpContext);
                var result = await _productService.UpdateAsync(id, workspaceId, request, cancellationToken);
                return StatusCode(result.StatusCode, result);
            }
            catch (UnauthorizedAccessException)
            {
        ...
        public async Task<ActionResult<GenericResponse<bool>>> SoftDelete(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            {
                var workspaceId = WorkspaceContextHelper.GetActiveWorkspaceIdOrThrow(HttpContext);
                var result = await _productService.SoftDeleteAsync(id, workspaceId, cancellationToken);
                return StatusCode(result.StatusCode, result);
            }
            catch (UnauthorizedAccessException)
            {
        ...
        public async Task<ActionResult<GenericResponse<bool>>> Restore(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            {
                var workspaceId = WorkspaceContextHelper.GetActiveWorkspaceIdOrThrow(HttpContext);
                var result = await _productService.RestoreAsync(id, workspaceId, cancellationToken);
                return StatusCode(result.StatusCode, result);
            }
            catch (UnauthorizedAccessException)
            {
