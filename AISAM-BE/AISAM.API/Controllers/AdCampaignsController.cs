...
namespace AISAM.API.Controllers
{
    ...
    public class AdCampaignsController : ControllerBase
    {
        ...
        public async Task<ActionResult<GenericResponse<AdCampaignDto>>> GetById(
            Guid campaignId,
            CancellationToken cancellationToken = default)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<GenericResponse<AdCampaignDto>>> Create(
            [FromBody] CreateAdCampaignRequest request,
            CancellationToken cancellationToken = default)
        {
            var result = await _adCampaignService.CreateInWorkspaceAsync(
                GetWorkspaceId(),
                GetWorkspaceUserId(),
                request,
                cancellationToken);
        ...
        public async Task<ActionResult<GenericResponse<AdCampaignDto>>> Update(
            Guid campaignId,
        ...
        public async Task<ActionResult<GenericResponse<AdCampaignDto>>> Sync(
            Guid campaignId,
            CancellationToken cancellationToken = default)
        {
        ...
        private Guid GetWorkspaceUserId()
        {
            return WorkspaceContextHelper.GetActiveWorkspaceMembershipOrThrow(HttpContext).UserId;
        }
    }
}
