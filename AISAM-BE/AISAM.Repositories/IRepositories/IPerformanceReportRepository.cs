...
public interface IPerformanceReportRepository
{
    ...
    Task<IReadOnlyList<AnalyticsChannelBreakdownDto>> GetChannelBreakdownForAIAsync(Guid workspaceId, DateTime from, DateTime to, Guid? brandId = null, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<TopPostItemDto>> GetTopPostsForAIAsync(Guid workspaceId, DateTime from, DateTime to, Guid? brandId = null, string? platform = null, int take = 3, CancellationToken cancellationToken = default);
