...
public interface INotificationRepository
{
    ...
    Task<PagedResult<Notification>> GetPagedByWorkspaceIdAsync(Guid workspaceId, Guid currentProfileId, PaginationRequest request, CancellationToken cancellationToken = default)
    ...
    Task<int> GetUnreadCountByWorkspaceIdAsync(Guid workspaceId, Guid currentProfileId, CancellationToken cancellationToken = default) => throw new NotSupportedException();
    Task MarkAllAsReadByWorkspaceIdAsync(Guid workspaceId, Guid currentProfileId, CancellationToken cancellationToken = default) => throw new NotSupportedException();
