...
namespace AISAM.Repositories.Migrations
{
    ...
    [Migration("20260727035935_AddCampaignInsightSnapshots")]
    partial class AddCampaignInsightSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AISAM.Data.Model.CampaignInsightSnapshot", b =>
                {
                    ...
                    b.HasIndex("CampaignId", "Platform", "SnapshotDate", "AttributionWindow")
                        .IsUnique();
            ...
            modelBuilder.Entity("AISAM.Data.Model.CampaignInsightSnapshot", b =>
                {
                    b.HasOne("AISAM.Data.Model.AdCampaign", "Campaign")
                        .WithMany("InsightSnapshots")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AISAM.Data.Model.Workspace", "Workspace")
                        .WithMany("CampaignInsightSnapshots")
                        .HasForeignKey("WorkspaceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AISAM.Data.Model.Workspace", b =>
                {
                    ...
                    b.Navigation("CampaignInsightSnapshots");
