...
{
    Task<GenericResponse<AutomationPlanDto>> CreateAsync(Guid workspaceId, Guid profileId, Guid actorUserId, CreateAutomationPlanRequest request, string? sourceFileName = null, CancellationToken cancellationToken = default);
    Task<GenericResponse<AutomationPlanDto>> ImportCsvAsync(Guid workspaceId, Guid profileId, Guid actorUserId, string name, string timezone, string sourceFileName, Stream stream, CancellationToken cancellationToken = default);
    ...
    Task<GenericResponse<AutomationPlanDto>> ImportGoogleSheetAsync(Guid workspaceId, Guid profileId, Guid actorUserId, ImportGoogleSheetRequest request, CancellationToken cancellationToken = default);
    Task<GenericResponse<AutomationPlanDto>> CloneAsync(Guid workspaceId, Guid profileId, Guid actorUserId, Guid planId, CloneAutomationPlanRequest request, CancellationToken cancellationToken = default);
