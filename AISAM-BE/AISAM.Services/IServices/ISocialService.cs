...
public interface ISocialService
{
    ...
    Task<SocialAccountDto> LinkSelectedTargetsInWorkspaceAsync(Guid workspaceId, Guid profileId, Guid socialAccountId, LinkSelectedTargetsRequest request, CancellationToken cancellationToken = default, Guid? actorUserId = null) => LinkSelectedTargetsForAccountAsync(profileId, socialAccountId, request, cancellationToken);
    ...
    Task<bool> UnlinkAccountInWorkspaceAsync(Guid workspaceId, Guid socialAccountId, CancellationToken cancellationToken = default, Guid? actorUserId = null) => UnlinkAccountAsync(workspaceId, socialAccountId, cancellationToken);
