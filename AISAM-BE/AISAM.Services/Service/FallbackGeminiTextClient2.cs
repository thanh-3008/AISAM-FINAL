...
public sealed class FallbackGeminiTextClient2 : IGeminiTextClient
{
    ...
    private readonly ILogger<FallbackGeminiTextClient2> _logger;

    public FallbackGeminiTextClient2(
        HttpClient httpClient,
        IOptions<GeminiSettings> settings,
        ILogger<FallbackGeminiTextClient2>? logger = null)
    {
        _httpClient = httpClient;
        _settings = settings.Value;
        _logger = logger ?? Microsoft.Extensions.Logging.Abstractions.NullLogger<FallbackGeminiTextClient2>.Instance;
    }
    ...
    public async Task<string> GenerateAsync(string prompt, CancellationToken cancellationToken = default)
    {
        ...
        GeminiDiagnosticLogging.LogResponseMetadata(_logger, "FallbackGemini2", model, document.RootElement);
