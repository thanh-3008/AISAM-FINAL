...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260904112639_MutationPermissionRevision') THEN
    ALTER TABLE workspaces ADD permission_revision bigint NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260904112639_MutationPermissionRevision') THEN
    ALTER TABLE execution_operations ADD execution_version integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260904112639_MutationPermissionRevision') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260904112639_MutationPermissionRevision', '9.0.9');
    END IF;
END $EF$;
COMMIT;
